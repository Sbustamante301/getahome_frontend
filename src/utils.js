import {RiArrowDownSLine,RiNotificationFill,RiArticleLine,RiFileUserLine,RiNotificationLine,
    RiCheckFill,RiCloseLine,RiMoneyDollarCircleFill,RiBriefcaseLine,RiUserLine,RiHeartLine,RiMoneyDollarCircleLine,RiFocusLine,
...
export const Icons = {
    ...
    heart: RiHeartLine,
    dollarCircle: RiMoneyDollarCircleLine,
    focus: RiFocusLine,
    mail: RiMailLine,
    time: RiTimeLine,
    github: RiGithubFill,
    ...
    twitter: <RiTwitterFill style={{height:40, width:40,color:`${colors.pink.shallow}`}}/>,
    search: RiSearchLine,
    react: RiReactjsLine,
    ruby: DiRuby,
